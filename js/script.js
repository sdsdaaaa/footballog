...
if (windowOffsetY > window.innerHeight - 250) windowOffsetY = 200;
 ...
 win.innerHTML = `
  <div class="window-wrapper" style="display: flex; flex-direction: column; height: 100%;">
 ...
 <div class="window-content" style="display: flex; flex-direction: column; height: calc(100% - 40px);">
      <iframe src="pages/${id}.html" style="flex-grow: 1; border: none;"></iframe>
    </div>
...
// 🔍 검색창에서 Enter 입력 시 search.html로 이동
